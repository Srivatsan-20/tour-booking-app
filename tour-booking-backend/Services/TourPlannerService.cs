            ...
            GeocodingResult startLocation)
        {
            ...
            for (int day = 1; day <= request.NumberOfDays; day++)
            {
                ...
                while (remainingPlaces.Any() && dailyDrivingMinutes < maxDrivingMinutesPerDay)
                {
                    ...
                    var placeIndex = allLocations.IndexOf(nearestPlace.place.Name);
                    ...
                    var visitDurationMinutes = nearestPlace.request.CustomVisitDurationMinutes ?? nearestPlace.place.DefaultVisitDurationMinutes;
                    ...
                    if (day == request.NumberOfDays)
                    {
                        ...
                        {
                            response.ExcludedPlaces.Add($"{nearestPlace.place.Name} - Cannot return to base by deadline");
